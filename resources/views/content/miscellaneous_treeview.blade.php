...
@section('pages-css')
    <link rel="stylesheet" media="screen, print" href="{{ asset('') }}assets/css/miscellaneous/treeview/treeview.css">
@endsection
...
@section('pages-script')
    <script src="{{ asset('') }}assets/js/miscellaneous/treeview/treeview.js"></script>
    <script>
