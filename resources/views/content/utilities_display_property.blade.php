            ...
            <div class="d-flex flex-start w-100">
                ...
                <div class="d-flex flex-fill">
                    <div class="flex-fill">
                        ...
                        <br> Change the value of the display property with our responsive display utility classes. We
                        purposely support only a subset of all possible values for display. Classes can be combined for
            ...
            <div class="col-xl-6">
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Display utility classes that apply to all <a href="utilities_responsive_grid.html"
                                    target="_blank">breakpoints</a>, from <code>xs</code> to <code>xl</code>, have no
                            ...
                            <ul class="list-spaced">
                                ...
                                <li><code>.d-{breakpoint}-{value}</code> for <code>sm</code>, <code>md</code>,
                            ...
                            <p>The media queries effect screen widths with the given breakpoint <em>or larger</em>. For
                                example, <code>.d-lg-none</code> sets <code>display: none;</code> on both <code>lg</code>
                                and <code>xl</code> screens.</p>
                        </div>
                    </div>
                </div>
                <div id="panel-2" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                This method for hidding elements is from Bootstrap version 3.0, it is a more quicker way of
                                hiding responsive elements. However, the Bootstrap 4 method will give you greater control.
                                <strong>Remember to use either of the method on a single element, otherwise it may not
                                    work</strong>
                            </div>
            ...
            <div class="col-xl-6">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <p>
                                ...
                                utility classes. Includes support for the same <code>display</code> values as our responsive
                ...
                <div id="panel-4" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                <p>For faster mobile-friendly development, use responsive display classes for showing and
                                    hiding elements by device. Avoid creating entirely different versions of the same site,
                                    instead hide elements responsively for each screen size.</p>
                                <p>To hide elements simply use the <code>.d-none</code> class or one of the
                                    <code>.d-{sm,md,lg,xl}-none</code> classes for any responsive screen variation.
                                </p>
                                <p>To show an element only on a given interval of screen sizes you can combine one
                                    <code>.d-*-none</code> class with a <code>.d-*-*</code> class, for example <code>.d-none
                                        .d-md-block .d-xl-none</code> will hide the element for all screen sizes except on
