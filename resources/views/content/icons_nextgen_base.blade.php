...
@section('pages-content')
    <main id="js-page-content" role="main" class="page-content">
        @include('layouts._page_breadcrumb', [
            ...
            'category_2' => 'NextGen Icons',
        ])
        <div class="subheader">
            @component('layouts._page_heading', [
                'heading1' => 'NextGen Icons:',
                'heading2' => 'Base',
                ...
                <div class="d-flex flex-fill">
                    <div class="flex-fill">
                        ...
                        used as regular general icons. To see base icons in action see the <a
                            href="icons_stack_showcase.html" target="_blank">Stack Icons Showcase</a> page.
                    </div>
                </div>
            </div>
        </div>
...
@section('pages-script')
    <script>
        ...
        var filename = "{{ asset('') }}assets/media/data/ng-icon-base.json";
