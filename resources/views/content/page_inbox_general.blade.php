                ...
                <div class="flex-grow-0">
                    ...
                    <div
                        ...
                        <div class="flex-1 d-flex align-items-center">
                            ...
                            <a href="javascript:void(0);" id="js-delete-selected"
                            ...
                            <ul id="js-emails" class="notification notification-layout-2">
                                <li class="unread">
                                    <div
                                        ...
                                        <a href="#" title="starred"
                                            class="d-flex align-items-center py-1 ml-2 mt-4 mt-lg-0 ml-lg-0 mr-lg-4 fs-lg color-warning-500 order-3 order-lg-2"><i
                                ...
                                <li class="unread">
                                    <div
                                        ...
                                        <a href="#" title="Not starred"
                                            class="d-flex align-items-center py-1 ml-2 mt-4 mt-lg-0 ml-lg-0 mr-lg-4 fs-lg text-muted order-3 order-lg-2"><i
                        ...
                        <div class="flex-1" style="overflow-y: auto;">
                            <div id='fake_textarea' class="form-control rounded-0 w-100 h-100 border-0 py-3"
                                ...
                                <div class="text-muted fs-nano">
                                    ​PRIVATE AND CONFIDENTIAL. This e-mail, its contents and attachments are
                                    private and confidential and is intended for the recipient only. Any
                                    disclosure, copying or unauthorized use of such information is
                                    prohibited. If you receive this message in error, please notify us
                                    immediately and delete the original and any copies and attachments.
                                </div>
                            </div>
                        </div>
