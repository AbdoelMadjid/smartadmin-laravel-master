    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="d-flex flex-grow-1 p-0 border-faded shadow-4" style="max-height:800px;">
                            ...
                            <ul class="list-unstyled m-0">
                                <li>
                                    <div
                                        ...
                                        <div class="profile-image-md rounded-circle"
                                            style="background-image:url('{{ asset('') }}assets/img/demo/avatars/avatar-d.png'); background-size: cover;">
                                        </div>
                                        ...
                                        <div class="position-absolute pos-right mt-2 mr-3 show-on-hover-parent">
                                            <button class="btn btn-danger btn-xs btn-icon rounded-circle shadow-0"
                                                data-toggle="tooltip"
                                ...
                                <li>
                                    <div
                                        class="d-flex w-100 px-3 py-2 text-dark hover-white cursor-pointer show-child-on-hover">
                                        <div class="profile-image-md rounded-circle"
                                            style="background-image:url('{{ asset('') }}assets/img/demo/avatars/avatar-b.png'); background-size: cover;">
                                        </div>
                                        <div class="px-2 flex-1">
                                            <div class="text-truncate text-truncate-md">
                                                Oliver Kopyuv
                                ...
                                <li>
                                    <div
                                        class="d-flex w-100 px-3 py-2 text-dark hover-white cursor-pointer show-child-on-hover">
                                        <div class="profile-image-md rounded-circle"
                                            style="background-image:url('{{ asset('') }}assets/img/demo/avatars/avatar-e.png'); background-size: cover;">
                                        </div>
                                        <div class="px-2 flex-1">
                                            <div class="text-truncate text-truncate-md">
                                                Dr. John Cook PhD
                                ...
                                <li>
                                    <div
                                        class="d-flex w-100 px-3 py-2 text-dark hover-white cursor-pointer show-child-on-hover">
                                        <div class="profile-image-md rounded-circle"
                                            style="background-image:url('{{ asset('') }}assets/img/demo/avatars/avatar-g.png'); background-size: cover;">
                                        </div>
                                        <div class="px-2 flex-1">
                                            <div class="text-truncate text-truncate-md">
                                                Ali Amdaney
                            ...
                            <ul class="list-unstyled m-0">
                                <li>
                                    <div
                                        class="d-flex w-100 px-3 py-2 text-dark hover-white cursor-pointer show-child-on-hover">
                                        <div class="profile-image-md rounded-circle"
                                            style="background-image:url('{{ asset('') }}assets/img/demo/avatars/avatar-m.png'); background-size: cover;">
                                        </div>
                                        <div class="px-2 flex-1">
                                            <div class="text-truncate text-truncate-md">
                                                +714651347790
                                        ...
                                        <div class="position-absolute pos-right mt-2 mr-3 show-on-hover-parent">
                                            <button class="btn btn-success btn-xs btn-icon rounded-circle shadow-0"
                                                data-toggle="tooltip"
            ...
            <div class="slide-backdrop" data-action="toggle" data-class="slide-on-mobile-left-show"
                data-target="#js-chat-contact"></div> <!-- end left slider -->
            <!-- inbox container -->
            <div class="d-flex flex-column flex-grow-1 bg-white">
                ...
                <div class="flex-grow-0">
                    <!-- inbox title -->
                    <div
                        class="d-flex align-items-center p-0 border-faded border-top-0 border-left-0 border-right-0 flex-shrink-0">
                        <div class="d-flex align-items-center w-100 pl-3 px-lg-4 py-2 position-relative">
                            ...
                            <div class="ml-auto">
                                <a href="javascript:void(0);" data-toggle="button"
                        ...
                        <a href="javascript:void(0);"
                            class="px-3 py-2 d-flex d-lg-none align-items-center justify-content-center mr-2 btn"
