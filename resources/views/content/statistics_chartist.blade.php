...
@section('pages-css')
    <link rel="stylesheet" media="screen, print" href="{{ asset('') }}assets/css/statistics/chartist/chartist.css">
@endsection
            ...
            <div class="d-flex flex-start w-100">
                ...
                <div class="d-flex flex-fill">
                    <div class="flex-fill">
                        ...
                        <p>Chartist's goal is to provide a simple, lightweight and unintrusive library to responsively craft
                            charts on your website. Chartist leverages the power of browsers today and say good bye to the
                            idea of solving all problems ourselves.
                        </p>
                        <p>
                            Chartist works with inline-SVG and therefore leverages the power of the DOM to provide parts of
                            its functionality. This also means that Chartist does not provide it's own event handling,
                            labels, behaviors or anything else that can just be done with plain HTML, JavaScript and CSS.
                            The single and only responsibility of Chartist is to help you drawing "Simple responsive Charts"
                            using inline-SVG in the DOM, CSS to style and JavaScript to provide an API for configuring your
                            charts.</p>
                        <p class="m-0">
                            Find tutorials, guidelines and more on their <a
                                href="https://gionkunz.github.io/chartist-js/getting-started.html" target="_blank">official
                                documentation</a>
                        </p>
                    </div>
                </div>
            ...
            <div class="col-xl-6">
                ...
                <div id="panel-2" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                This advanced example uses a line chart to draw a scatter diagram. The data object is
                                created with a functional style random mechanism. There is a mobile first responsive
                                configuration using the responsive options to show less labels on small screens.
                            </div>
                ...
                <div id="panel-3" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Chartist has fixed graphical representations that are chosen because of their flexibility
                                and to provide a high level of separation of the concerns. However, sometimes you probably
                                would like to use different shapes or even images for your charts. One way to achieve this
                                is by using the draw events and replace or add custom SVG shapes.
                            </div>
                ...
                <div id="panel-4" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                You can also only draw the area shapes of the line chart. Area shapes will always be
                                constructed around their areaBase which also allows you to draw nice bi-polar areas.
                            </div>
                ...
                <div id="panel-5" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Chartist provides simple API to animate the Chart elements using SMIL. You can do most
                                animation with CSS but in some cases you'd like to animate SVG properties that are not
                                available in CSS
                            </div>
                ...
                <div id="panel-6" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Guess what! Creating horizontal bar charts is as simple as it can get. There's no new chart
                                type you need to learn, just passing an additional option is enough
                            </div>
                ...
                <div id="panel-9" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                This example makes use of label interpolation and the seriesBarDistance property that allows
                                you to make bars overlap over each other. This then can be used to use the available space
                                on mobile better. Resize your browser to see the effect of the responsive configuration.
                            </div>
                ...
                <div id="panel-10" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Customized responsive configuration, you can create a chart that adopts to every media
                                condition!
                            </div>
            ...
            <div class="col-xl-6">
                ...
                <div id="panel-13" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Chartist will figure out if your browser supports foreignObject and it will use them to
                                create labels that are based on regular HTML text elements. Multi-line and regular CSS
                                styles are just two of many benefits while using foreignObjects!
                            </div>
                ...
                <div id="panel-14" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                By naming your series using the series object notation with a name property, you can enable
                                the individual configuration of series specific settings. <code>showLine</code>,
                                <code>showPoint</code>, <code>showArea</code> and even the smoothing function can be
                                overriden per series! And guess what? You can even override those series settings in the
                ...
                <div id="panel-15" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                You can also set your bar chart to stack the series bars on top of each other easily by
                                using the <code>stackBars</code> property in your configuration.
                            </div>
                ...
                <div id="panel-16" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Path animation is made easy with the SVG Path API. The API allows you to modify complex SVG
                                paths and transform them for different animation morphing states.
                            </div>
                ...
                <div id="panel-17" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                You can change the position of the labels on line and bar charts easily by using the
                                <code>position</code> option inside of the axis configuration.
                            </div>
                ...
                <div id="panel-20" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Sometime it's desired to have bar charts that show one bar per series distributed along the
                                x-axis. If this option is enabled, you need to make sure that you pass a single series array
                                to Chartist that contains the series values. In this example you can see T-shirt sales of a
                                store categorized by size.
                            </div>
...
@section('pages-script')
    ...
    <script src="{{ asset('') }}assets/js/statistics/chartist/chartist.js"></script>
    <script>
        /* line chart area */
        ...
        var multiLineLabels = function() {
            new Chartist.Bar('#multiLineLabels', {
                labels: ['First quarter of the year', 'Second quarter of the year', 'Third quarter of the year',
