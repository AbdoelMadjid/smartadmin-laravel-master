                ...
                <div class="d-flex flex-fill">
                    <div class="flex-fill">
                        ...
                        <p>
                            ...
                            upon the foundations of progressive enhancement, that adds all of these advanced features to any
                            HTML table.
                            The stated goal of DataTables is "To enhance the accessibility of data in HTML tables". In order
                            to achieve this we recognise that DataTables has two categories of users that interact with the
                            interfaces the software has:
                        </p>
                        <ul>
                            <li>
                            ...
                            <li>
                                Developers - yourself and the other developers working with DataTables to create your apps,
                                sites, services, etc.
                            </li>
                        </ul>
                        <p class="m-0">
                            Find in-depth, guidelines, tutorials and more on Datatables's <a
                                href="https://www.datatables.net/manual/" target="_blank">Official Documentation</a>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                This example shows DataTables and the Responsive extension being used with the Bootstrap
                                framework providing the styling. The DataTables / Bootstrap integration provides seamless
                                integration for DataTables to be used in a Bootstrap page. <strong>Note</strong> that the
                                <code>.dt-responsive</code> class is used to indicate to the extension that it should be
                                enabled on this page, as responsive has special meaning in Bootstrap. The responsive option
