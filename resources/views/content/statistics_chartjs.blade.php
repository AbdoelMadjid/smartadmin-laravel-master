            ...
            <div class="d-flex flex-start w-100">
                ...
                <div class="d-flex flex-fill">
                    <div class="flex-fill">
                        ...
                        <p>Chart.js is a JavaScript library that allows you to draw different types of charts by using the
                            HTML5 <code>canvas</code> element.</p>
                        <p>
                            The library doesn’t have dependencies and its weight is very low as it’s ~11kb in size when
                            minified, concatenated, and served gzipped. However, you’re able to reduce the size even
                            further, if you don’t use all six of the core chart types, by including only the modules you
                            need.
                        </p>
                        <p class="m-0">
                            Find tutorials, guidelines and more on Chart.js's <a href="https://www.chartjs.org/docs/latest/"
                            ...
                            <div class="panel-container show">
                                <div class="panel-content">
                                    <div class="panel-tag">
                                        ...
                                        shown on the X axis. It has a colour for the fill, a colour for the line and colours
                                        for the points and strokes of the points
                                    </div>
                                    <div id="lineChart">
                    ...
                    <div class="col-xl-6">
                        <div id="panel-7" class="panel">
                            ...
                            <div class="panel-container show">
                                <div class="panel-content">
                                    <div class="panel-tag">
                                        An area chart or area graph displays graphically quantitative data. It is based on
                                        the line chart. The area between axis and line are commonly emphasized with colors,
                    ...
                    <div class="col-xl-6">
                        <div id="panel-2" class="panel">
                            ...
                            <div class="panel-container show">
                                <div class="panel-content">
                                    <div class="panel-tag">
                                        A horizontal bar chart provides a way of showing data values represented as
                                        horizontal bars. It is sometimes used to show trend data, and the comparison of
                                        multiple data sets on top of another
                                    </div>
                    ...
                    <div class="col-xl-6">
                        <div id="panel-8" class="panel">
                            ...
                            <div class="panel-container show">
                                <div class="panel-content">
                                    <div class="panel-tag">
                                        A bar chart provides a way of showing data values represented as vertical bars. It
                    ...
                    <div class="col-xl-6">
                        <div id="panel-3" class="panel">
                            ...
                            <div class="panel-container show">
                                <div class="panel-content">
                                    <div class="panel-tag">
                                        A stacked bar chart, is a graph that is used to break down and compare parts of a
                                        whole. Each bar in the chart represents a whole, and segments in the bar represent
                    ...
                    <div class="col-xl-6">
                        <div id="panel-9" class="panel">
                            ...
                            <div class="panel-container show">
                                <div class="panel-content">
                                    <div class="panel-tag">
                                        A stacked horizontal bar chart, shows you a breakdown and compare parts of a whole.
                                        Each segment displays a whole brown down into different parts or categories -
                                        displayed on top of another
                                    </div>
                    ...
                    <div class="col-xl-6">
                        <div id="panel-4" class="panel">
                            ...
                            <div class="panel-container show">
                                <div class="panel-content">
                                    <div class="panel-tag">
                                        A bubble chart is used to display three dimensions of data. The location of the
                                        bubble is determined by the first two dimensions and the third dimension is
                    ...
                    <div class="col-xl-6">
                        <div id="panel-10" class="panel">
                            ...
                            <div class="panel-container show">
                                <div class="panel-content">
                                    <div class="panel-tag">
                                        This is a combination of different charts presented together to show how easy it is
                                        to built complex charts. Here we use similar data sets to combine a linechart with
                                        bar chart
                                    </div>
                    ...
                    <div class="col-xl-6">
                        <div id="panel-5" class="panel">
                            ...
                            <div class="panel-container show">
                                <div class="panel-content">
                                    <div class="panel-tag">
                                        Polar charts are similar to pie charts, but each segment has the same angle - the
                                        radius of the segment differs depending on the value. Polar charts is often useful
                                        when we want to show a comparison data similar to a pie chart, but also show a scale
                    ...
                    <div class="col-xl-6">
                        <div id="panel-11" class="panel">
                            ...
                            <div class="panel-container show">
                                <div class="panel-content">
                                    <div class="panel-tag">
                                        For a radar chart, to provide context of what each point means, we include an array
                                        of strings that show around each point in the chart. For the radar chart data, we
                                        have an array of datasets as objects, with a fill, stroke, and line color for each
                                        point. We also have an array of data values
                                    </div>
                                    <div id="radarChart">
                                        <canvas style="width:100%; height:300px;"></canvas>
                                    </div>
                    ...
                    <div class="col-xl-6">
                        <div id="panel-6" class="panel">
                            ...
                            <div class="panel-container show">
                                <div class="panel-content">
                                    <div class="panel-tag">
                                        Pie charts are probably the most commonly used chart there are. They are divided
                                        into segments, the arc of each segment shows the proportional value of each piece of
                                        data
                                    </div>
                                    <div id="pieChart">
                                        <canvas style="width:100%; height:300px;"></canvas>
                    ...
                    <div class="col-xl-6">
                        <div id="panel-12" class="panel">
                            ...
                            <div class="panel-container show">
                                <div class="panel-content">
                                    <div class="panel-tag">
                                        Doughnut charts are probably the most commonly used chart there are. They are
                                        divided into segments, the arc of each segment shows the proportional value of each
                                        piece of data
                                    </div>
