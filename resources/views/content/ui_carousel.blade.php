...
@section('pages-content')
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="row">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                ...
                                additional utilities or custom styles to appropriately size content. While carousels support
                                previous/next controls and indicators, they’re not explicitly required. Add and customize as
                                you see fit.
                                <br>
                                <br>
                                <strong>The <code>.active</code> class needs to be added to one of the slides</strong>
                                otherwise the carousel will not be visible. Also be sure to set a unique id on the
                                <code>.carousel</code> for optional controls, especially if you’re using multiple carousels
                                on a single page. Control and indicator elements must have a <code>data-target</code>
                                attribute (or <code>href</code> for links) that matches the id of the <code>.carousel</code>
                                element.
                            </div>
                            <div id="carouselExampleKitchenSink" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="{{ asset('') }}assets/img/demo/relax-full.jpg" alt="First slide">
                                    ...
                                    <div class="carousel-item active">
                                        <img class="d-block w-100" src="{{ asset('') }}assets/img/demo/peace-full.jpg" alt="Second slide">
                                        <div class="carousel-caption d-none d-md-block">
                                    ...
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="{{ asset('') }}assets/img/demo/sea-full.jpg" alt="Third slide">
                                        <div class="carousel-caption d-none d-md-block">
                                ...
                                <a class="carousel-control-prev" href="#carouselExampleKitchenSink" role="button"
                                    data-slide="prev">
                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                    <span class="sr-only">Previous</span>
                                </a>
                                <a class="carousel-control-next" href="#carouselExampleKitchenSink" role="button"
                                    data-slide="next">
            ...
            <div class="col-xl-6">
                        ...
                        <div class="panel-content">
                            ...
                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block w-100" src="about:blank"
                                            data-src="holder.js/800x400?auto=yes&bg=fe85be&fg=ffffff&text=First slide"
                                            alt="First slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="about:blank"
                                            data-src="holder.js/800x400?auto=yes&bg=fe6bb0&fg=ffffff&text=Second slide"
                                            alt="Second slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="about:blank"
                                            data-src="holder.js/800x400?auto=yes&bg=fd52a3&fg=ffffff&text=Third slide"
                                            alt="Third slide">
                                    </div>
                                </div>
                ...
                <div id="panel-4" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Add <code>data-interval=""</code> to a <code>.carousel-item</code> to change the amount of
                                time to delay between automatically cycling to the next item. E.g The first image will
                                change after 10 seconds, the second one will change after 2 seconds, and the following will
                                change as default settings.
                            </div>
                            <div id="carouselExampleInterval" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active" data-interval="10000">
                                        <img class="d-block w-100" src="about:blank"
                                            data-src="holder.js/800x400?auto=yes&bg=ffd274&fg=333333&text=First slide"
                                            alt="First slide">
                                    </div>
                                    <div class="carousel-item" data-interval="2000">
                                        <img class="d-block w-100" src="about:blank"
                                            data-src="holder.js/800x400?auto=yes&bg=ffca5b&fg=000000&text=Second slide"
                                            alt="Second slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="about:blank"
                                            data-src="holder.js/800x400?auto=yes&bg=ffc241&fg=000000&text=Third slide"
                                            alt="Third slide">
                                    </div>
                                </div>
                        ...
                        <div class="panel-content">
                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block w-100" src="about:blank"
                                            data-src="holder.js/800x400?auto=yes&bg=37e2d0&fg=ffffff&text=First slide"
                                            alt="First slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="about:blank"
                                            data-src="holder.js/800x400?auto=yes&bg=21dfcb&fg=ffffff&text=Second slide"
                                            alt="Second slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="about:blank"
                                            data-src="holder.js/800x400?auto=yes&bg=1dc9b7&fg=ffffff&text=Third slide"
                                            alt="Third slide">
                                    </div>
                                </div>
                        ...
                        <div class="panel-content">
                            ...
                            <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block w-100" src="about:blank"
                                            data-src="holder.js/800x400?auto=yes&bg=a38cc6&fg=ffffff&text=First slide"
                                            alt="First slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="about:blank"
                                            data-src="holder.js/800x400?auto=yes&bg=967bbd&fg=ffffff&text=Second slide"
                                            alt="Second slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="about:blank"
                                            data-src="holder.js/800x400?auto=yes&bg=886ab5&fg=ffffff&text=Third slide"
                                            alt="Third slide">
                                    </div>
                                </div>
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                ...
                                any <code>.carousel-item</code>. They can be easily hidden on smaller viewports, as shown
                                below, with optional <a href="#" target="_blank">display utilities</a>. We hide them
                                initially with <code>.d-none</code> and bring them back on medium-sized devices with
                            ...
                            <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block w-100" src="about:blank"
                                            data-src="holder.js/800x400?auto=yes&bg=5a636d&fg=7f8995&text=First slide"
                                            alt="First slide">
                                        <div class="carousel-caption d-none d-md-block">
                                    ...
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="about:blank"
                                            data-src="holder.js/800x400?auto=yes&bg=5a636d&fg=7f8995&text=Second slide"
                                            alt="Second slide">
                                        <div class="carousel-caption d-none d-md-block">
                                    ...
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="about:blank"
                                            data-src="holder.js/800x400?auto=yes&bg=5a636d&fg=7f8995&text=Third slide"
                                            alt="Third slide">
                                        <div class="carousel-caption d-none d-md-block">
            ...
            <!-- Fullscreen Carousel -->
            <div class="modal fade modal-fullscreen example-carousel-fullscreen" tabindex="-1" role="dialog"
                aria-hidden="true">
                    ...
                    <div class="modal-content h-100 border-0 shadow-0 bg-fusion-800">
                        ...
                        <div class="modal-body p-0">
                            <div id="example-carousel-fullscreen" class="carousel slide" data-ride="carousel">
                                ...
                                <a class="carousel-control-prev" href="#example-carousel-fullscreen" role="button"
                                    data-slide="prev">
                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                    <span class="sr-only">Previous</span>
                                </a>
                                <a class="carousel-control-next" href="#example-carousel-fullscreen" role="button"
                                    data-slide="next">
                                    <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                    <span class="sr-only">Next</span>
                                </a>
