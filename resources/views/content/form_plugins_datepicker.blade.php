            ...
            <div class="d-flex flex-start w-100">
                ...
                <div class="d-flex flex-fill">
                    <div class="flex-fill">
                        ...
                        <p>Bootstrap datepicker allows the user to enter a date by merely clicking on a date in the pop-up
                            calendar as opposed to having to take their hand off the mouse to type in a date. The UI makes
                            easy to select the date and keep the proper formatting</p>
                        <p class="m-0">
                            Find in-depth, guidelines, tutorials and more on Bootstrap Datepicker's <a
                                href="https://bootstrap-datepicker.readthedocs.io/en/stable/" target="_blank">Official
                                Documentation</a>
                        </p>
                    </div>
                </div>
                        ...
                        <div class="panel-content">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12 col-lg-6 ">
                                    <input type="text" class="form-control" id="datepicker-1" readonly
                                        placeholder="Select date">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-12 col-lg-3 form-label text-lg-right">Input Group
                                    Setup</label>
                                <div class="col-12 col-lg-6">
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-12 col-lg-3 form-label text-lg-right">Enable Helper
                                    Buttons</label>
                                <div class="col-12 col-lg-6">
                                    <div class="input-group">
                                        <input type="text" class="form-control " readonly value="07/17/2020"
                                            id="datepicker-3">
                                        <div class="input-group-append">
                                            <span class="input-group-text fs-xl">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="datepicker-modal-3">Datepicker with
                                                    button</label>
                                                <div class="input-group">
