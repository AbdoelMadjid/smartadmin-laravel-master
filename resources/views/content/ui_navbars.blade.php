            ...
            <div class="col-xl-6">
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                <p>Navbars come with built-in support for a handful of sub-components. Choose from the
                                    following as needed:</p>
                                <ul>
                                    <li><code>.navbar-brand</code> for your company, product, or project name.</li>
                                    <li><code>.navbar-nav</code> for a full-height and lightweight navigation (including
                                        support for dropdowns).</li>
                                    <li><code>.navbar-toggler</code> for use with our collapse plugin and other <a
                                            href="#responsive-behaviors">navigation toggling</a> behaviors.</li>
                                    ...
                                    <li><code>.collapse.navbar-collapse</code> for grouping and hiding navbar contents by a
                                        parent breakpoint.</li>
                                </ul>
                            </div>
                ...
                <div id="panel-2" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                The <code>.navbar-brand</code> can be applied to most elements, but an anchor works best as
                            ...
                            <nav class="navbar navbar-light bg-light">
                                <a class="navbar-brand d-flex align-items-center fw-500" href="#">
                                    <img src="{{ asset('') }}assets/img/logo.png" class="d-inline-block align-top mr-2" alt="logo">
                                    SmartAdmin
                                </a>
                            </nav>
                        </div>
                ...
                <div id="panel-3" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                <p>Navbar navigation links build on our <code>.nav</code> options with their own modifier
                                    class and require the use of <a href="#toggler">toggler classes</a> for proper
                                    responsive styling. <strong>Navigation in navbars will also grow to occupy as much
                                        horizontal space as possible</strong> to keep your navbar contents securely aligned.
                                </p>
                            </div>
                            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                                <a class="navbar-brand d-flex align-items-center fw-500" href="#">
            ...
            <div class="col-xl-6">
                <div id="panel-5" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                <p>Theming the navbar has never been easier thanks to the combination of theming classes and
                                    <code>background-color</code> utilities. Choose from <code>.navbar-light</code> for use
                                    with light background colors, or <code>.navbar-dark</code> for dark background colors.
                            ...
                            <div class="demo">
                                <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                                    <a class="navbar-brand d-flex align-items-center fw-500" href="#">
                                        <img src="{{ asset('') }}assets/img/logo.png" class="d-inline-block align-top mr-2"
                                            alt="logo">
                                        SmartAdmin
                                    </a>
                                    <button class="navbar-toggler" type="button" data-toggle="collapse"
                                    ...
                                    <div class="collapse navbar-collapse" id="navbarColor01">
                                        ...
                                        <button type="button" class="btn btn-info" data-toggle="popover"
                                            data-container="#navbarColor01" data-placement="top" title=""
                                            data-html="true"
                                            data-content='
                                ...
                                <nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-primary-gradient">
                                    ...
                                    <div class="collapse navbar-collapse" id="navbarColor02">
                                        ...
                                        <button type="button" class="btn btn-outline-light" data-toggle="popover"
                                            data-container="#navbarColor02" data-placement="top" title=""
                                            data-html="true"
                                            data-content='
									<form class="form-inline">
										<input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search">
                                ...
                                <nav class="navbar navbar-expand-lg navbar-light">
                                    ...
                                    <div class="collapse navbar-collapse" id="navbarColor03">
                                        ...
                                        <button type="button" class="btn btn-outline-danger" data-toggle="popover"
                                            data-container="#navbarColor03" data-placement="top" title=""
                                            data-html="true"
                                            data-content='
									<form class="form-inline">
										<input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search">
                ...
                <div id="panel-6" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                <p>Use <a href="#">position utilities</a> to place navbars in non-static positions.
                                    Choose from fixed to the top, fixed to the bottom, or stickied to the top (scrolls with
                                    the page until it reaches the top, then stays there). Fixed navbars use <code>position:
                                        fixed</code>, meaning they’re pulled from the normal flow of the DOM and may require
                                    custom CSS (e.g., <code>padding-top</code> on the <code>&lt;body&gt;</code>) to prevent
                                    overlap with other elements.</p>
                                Also note that <strong><code>.sticky-top</code> uses <code>position: sticky</code>, which <a
                                        href="https://caniuse.com/#feat=css-sticky" target="_blank">isn’t fully supported
                                        in every browser</a></strong>
                            </div>
                            <div class="position-relative overflow-auto" style="height: 300px;">
                                ...
                                <nav class="navbar navbar-expand-lg navbar-light bg-warning-500 sticky-top">
                                    ...
                                    <button class="navbar-toggler" type="button" data-toggle="collapse"
                                        data-target="#navbarSticky" aria-controls="navbarText" aria-expanded="false"
                                        aria-label="Toggle navigation">
                                        <span class="navbar-toggler-icon"></span>
                                    </button>
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus imperdiet, nulla et
                                    ...
                                    eros non fermentum. Sed dapibus pulvinar nibh tempor porta. Cras ac leo purus. Mauris
                                    quis diam velit. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus
                                    imperdiet, nulla et dictum interdum, nisi lorem egestas odio, vitae scelerisque enim
                                    ...
                                    Cras ac leo purus. Mauris quis diam velit. Lorem ipsum dolor sit amet, consectetur
                                    adipiscing elit. Phasellus imperdiet, nulla et dictum interdum, nisi lorem egestas odio,
                                    vitae scelerisque enim ligula venenatis dolor. Maecenas nisl est, ultrices nec congue
                                    ...
                                    nibh tempor porta. Cras ac leo purus. Mauris quis diam velit. Lorem ipsum dolor sit
                                    amet, consectetur adipiscing elit. Phasellus imperdiet, nulla et dictum interdum, nisi
                                    lorem egestas odio, vitae scelerisque enim ligula venenatis dolor. Maecenas nisl est,
                                    ...
                                    lacus interdum ut hendrerit risus congue. Nunc sagittis dictum nisi, sed ullamcorper
                                    ipsum dignissim ac. In at libero sed nunc venenatis imperdiet sed ornare turpis. Donec
                                    vitae dui eget tellus gravida venenatis. Integer fringilla congue eros non fermentum.
                            ...
                            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                                ...
                                <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                                    ...
                                    <a href="javascript:void(0);"
                                        class="width-3 height-2 d-inline-flex align-items-center justify-content-center position-relative h1 mr-1 mb-0">
