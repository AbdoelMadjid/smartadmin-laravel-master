                            ...
                            <div class="d-flex">
                                <div>
                                    <div class="custom-control d-flex custom-switch">
                                        <input id="eventlog-switch" type="checkbox" class="custom-control-input"
                                            checked="checked">
                                        <label class="custom-control-label fw-500" for="eventlog-switch">Debugger
                                            Active</label>
                                    </div>
                                </div>
                                <div class="flex-1 text-right">
                                    <a href="#" class="btn btn-sm btn-outline-primary mr-1 ml-0" data-toggle="modal"
                            ...
                            <table class="table table-hover table-bordered m-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <button class="btn btn-outline-dark btn-sm mr-2"
                                                onclick="initApp.saveSettings()">initApp.saveSettings()</button>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <button class="btn btn-outline-dark btn-sm mr-2"
                                                onclick="initApp.resetSettings()">initApp.resetSettings()</button>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <button class="btn btn-outline-dark btn-sm mr-2"
                                                onclick="initApp.factoryReset()">initApp.factoryReset()</button>
                                        </td>
                                        <td>
                                            <i class="text-muted">-</i>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <button class="btn btn-outline-dark btn-sm mr-2"
                                                onclick="initApp.accessIndicator()">initApp.accessIndicator()</button>
                                        </td>
                                        <td>
                                            <i class="text-muted">-</i>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <button class="btn btn-outline-dark btn-sm mr-2"
                                                onclick="initApp.pushSettings()">initApp.pushSettings()</button>
                                        </td>
                                        <td>
                                            <i class="text-muted">-</i>
                                        </td>
                                        <td class="fs-sm">
                                            Push array to <code>body</code> tag. See <a
                                                href="settings_saving_db.html">saving to database</a> for more details
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <button class="btn btn-outline-dark btn-sm mr-2"
                                                onclick="initApp.getSettings()">initApp.getSettings()</button>
                                        </td>
                                        <td>
                                            <i class="fw-500 text-primary">string</i>
                                        </td>
                                        <td class="fs-sm">
                                            Fetch class names from <code>body</code> and convert them to JSON string. See <a
                                                href="settings_saving_db.html">saving to database</a> for more details
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <button class="btn btn-outline-dark btn-sm mr-2"
                                                onclick="initApp.detectBrowserType()">initApp.detectBrowserType()</button>
                                        </td>
                                        <td>
                                            <i class="fw-500 text-primary">string</i>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <button class="btn btn-outline-dark btn-sm mr-2"
                                                onclick="initApp.addDeviceType()">initApp.addDeviceType()</button>
                                        </td>
                                        <td>
                                            <i class="fw-500 text-primary">string</i>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <button class="btn btn-outline-dark btn-sm mr-2"
                                                onclick="initApp.windowScrollEvents()">initApp.windowScrollEvents()</button>
                                        </td>
                                        <td>
                                            <i class="text-muted">-</i>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <button class="btn btn-outline-dark btn-sm mr-2"
                                                onclick="initApp.checkNavigationOrientation()">initApp.checkNavigationOrientation()</button>
                                        </td>
                                        <td>
                                            <i class="text-muted">-</i>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <button class="btn btn-outline-dark btn-sm mr-2"
                                                onclick="initApp.buildNavigation(id)">initApp.buildNavigation(id)</button>
                                        </td>
                                        <td>
                                            <i class="fw-500 text-primary">string</i>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <button class="btn btn-outline-dark btn-sm mr-2"
                                                onclick="initApp.mobileCheckActivation()">initApp.mobileCheckActivation()</button>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <button class="btn btn-outline-dark btn-sm mr-2"
                                                onclick="initApp.toggleVisibility()">initApp.toggleVisibility()</button>
                                        </td>
                                        <td>
                                            <i class="text-muted">-</i>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <button class="btn btn-outline-dark btn-sm mr-2"
                                                onclick="initApp.domReadyMisc()">initApp.domReadyMisc()</button>
                                        </td>
                                        <td>
                                            <i class="text-muted">-</i>
                                        </td>
                                        <td class="fs-sm">
                                            Fires a series of events, see "Initialization shell" to your left, for more
                                            details.
                                        </td>
                                    </tr>
                                </tbody>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="fs-sm">
                                            ...
                                            <br>
                                            <code>data-action="toggle" data-class="class-a class-b"
                                            data-target="#ID"</code>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="fs-sm">
                                            <code>data-action="toggle-swap" data-class="class-a class-b"
                                            data-target="#ID"</code>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="fs-sm">
                                            <code>data-action="toggle-replace" data-replaceclass="classesToReplace"
                                            data-class="replaceWithClass" data-target="body"</code>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="fs-sm">
                                            ...
                                            <code>data-action="app-fullscreen" data-loadurl="script.js"
                                            data-loadfunction="functionName()"</code> or you can also use
                                            <code>initApp.loadScript("js/my_lovely_script.js", myFunction)</code>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td class="fs-sm">
                                            Play sounds using <code>data-action="playsound" data-soundpath="media/sound/"
                                            data-soundfile="filename" (no file extensions)</code>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
            ...
            <div class="col-xl-6">
                ...
                <div id="panel-4" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Define preferred application behaviors or configuration options; can modify some
...
@section('pages-script')
    ...
    <script>
        ...
        console.log = function(message) {
            ...
            if (lastMsg != message) {
                $('#app-eventlog').append('<div class="highlight p-1"><span class="d-flex align-items-center">' +
                    '<span class="badge badge-primary mr-2 p-1 width-6">' + getTime() + '</span>' + message +
                    '</span></div>');
                lastMsg = message;
                repeatCount = 0;
                ...
                $('#app-eventlog').append('<div class="highlight p-1"><span class="d-flex align-items-center">' +
                    '<span class="badge badge-primary mr-2 p-1 width-6">' + getTime() + '</span>' +
                    '<span class="badge badge-success mr-1">' + repeatCount + '</span>' + message + '</span></div>');
                $('#app-eventlog').animate({
                    scrollTop: $('#app-eventlog').prop("scrollHeight")
                }, 200);
            }
