                        ...
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="col d-flex">
                                <a href="javascript:void(0);"
                                    class="btn btn-outline-success btn-sm ml-auto mr-2 flex-shrink-0">Add</a>
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="d-inline-flex flex-column">
                                                    <a href="javascript:void(0)" class="fs-lg fw-500 d-block">
                                                        Account information & Security <span
                                                            class="badge badge-warning rounded">Sticky</span>
                                                    </a>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-1 min-width-0">
                                                    <a href="javascript:void(0)" class="d-block text-truncate">
                                                        Duis vitae sapien urna. Proin pellentesque laoreet ligula pharetra
                                                        semper.
                                                    </a>
                                                    <div class="text-muted small text-truncate">
                                                        Today, 12:12 <a href="javascript:void(0)"
                                        ...
                                        <div class="p-3 p-md-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-1 min-width-0">
                                                    ...
                                                    <div class="text-muted small text-truncate">
                                                        Today, 05:01 <a href="javascript:void(0)"
                                                            class="text-info">gsnoopy520</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-3 p-md-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-1 min-width-0">
                                                    ...
                                                    <div class="text-muted small text-truncate">
                                                        Today, 02:25 <a href="javascript:void(0)"
                                                            class="text-info">lerem03</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-3 p-md-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-1 min-width-0">
                                                    ...
                                                    <div class="text-muted small text-truncate">
                                                        Today, 08:13 <a href="javascript:void(0)"
                                                            class="text-info">erakalambert</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-3 p-md-3">
                                            <div class="d-flex align-items-center">
                                                <div
                                                    class="d-inline-block align-middle status status-success status-sm mr-2">
                                                    <span class="profile-image-md rounded-circle d-block"
                                                        style="background-image:url('{{ asset('') }}assets/img/demo/avatars/avatar-f.png'); background-size: cover;"></span>
                                                </div>
                                                <div class="flex-1 min-width-0">
                                                    <a href="javascript:void(0)" class="d-block text-truncate">
                                                        Integer felis justo, condimentum vitae pharetra vel, hendrerit eget
                                                        orci.
                                                    </a>
                                                    <div class="text-muted small text-truncate">
                                                        Today, 06:01 <a href="javascript:void(0)"
                                                            class="text-info">elisamury</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md">
                                        <div class="p-3">
                                            <div class="d-flex">
                                                <span class="icon-stack display-4 mr-3 flex-shrink-0">
                                                    <i
                                                        class="base base-15 icon-stack-3x opacity-100 color-success-800"></i>
                                                    <i
                                                        class="base base-10 icon-stack-2x opacity-100 color-success-600"></i>
                                                    <i
                                                        class="fal fa-dollar-sign icon-stack-1x opacity-100 color-white"></i>
                                                </span>
                                                <div class="d-inline-flex flex-column">
                                                    <a href="javascript:void(0)" class="fs-lg fw-500 d-block">
                                                        Billing Department
                                        ...
                                        <div class="p-3">
                                            <div class="d-flex">
                                                <span class="icon-stack display-4 mr-3 flex-shrink-0">
                                                    ...
                                                    <i
                                                        class="fal fa-question icon-stack-1x opacity-100 color-fusion-800"></i>
                                                </span>
                                                <div class="d-inline-flex flex-column">
                                                    <a href="javascript:void(0)" class="fs-lg fw-500 d-block">
                                    ...
                                    <div class="col-8 col-md-3 hidden-md-down">
                                        <div class="p-3 p-md-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-1 min-width-0">
                                                    <a href="javascript:void(0)" class="d-block text-truncate">
                                                        Nunc id varius nisl, a feugiat eros. Nulla laoreet dignissim justo,
                                                        id viverra nibh suscipit in. Curabitur scelerisque ipsum nec dui
                                                        lacinia bibendum
                                                    </a>
                                                    <div class="text-muted small text-truncate">
                                                        Today, 05:25 <a href="javascript:void(0)"
                                                            class="text-info">kraluakosh</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md">
                                        <div class="p-3">
                                            <div class="d-flex">
                                                <div class="d-inline-flex flex-column">
                                                    <a href="javascript:void(0)" class="fs-lg fw-500 d-block">
                                                        Physician (ER doctors, surgeons, hospitalists) <span
                                                            class="badge badge-success">Has Access</span>
                                                    </a>
                                                    <div class="d-block text-muted fs-sm">
                                        ...
                                        <div class="p-3 p-md-3">
                                            <div class="d-flex align-items-center">
                                                <div
                                                    class="d-inline-block align-middle status status-success status-sm mr-2">
                                                    <span class="profile-image-md rounded-circle d-block"
                                                        style="background-image:url('{{ asset('') }}assets/img/demo/avatars/avatar-admin.png'); background-size: cover;"></span>
                                                </div>
                                                <div class="flex-1 min-width-0">
                                                    <a href="javascript:void(0)" class="d-block text-truncate">
                                                        Nam at justo magna. Aenean facilisis ultricies turpis
                                    ...
                                    <div class="col-md">
                                        <div class="p-3">
                                            <div class="d-flex">
                                                <div class="d-inline-flex flex-column">
                                                    <a href="javascript:void(0)" class="fs-lg fw-500 d-block">
                                                        Nurse (CRNA, RN, LPN/LVN, CNS) <span
                                                            class="badge badge-success">Has Access</span>
                                                    </a>
                                                    <div class="d-block text-muted fs-sm">
                                                        Nulla laoreet dignissim justo, id viverra nibh suscipit in.
                                    ...
                                    <div class="col-md">
                                        <div class="p-3">
                                            <div class="d-flex">
                                                <div class="d-inline-flex flex-column">
                                                    <a href="javascript:void(0)" class="fs-lg fw-500 d-block">
                                                        Therapist (Physical Therapist, Radiation Therapist) <span
                                                            class="badge badge-danger">Password</span>
                                                    </a>
                                                    <div class="d-block text-muted fs-sm">
                                                        Curabitur scelerisque ipsum nec dui lacinia bibendum
                                                    </div>
                                    ...
                                    <div class="col-md">
                                        <div class="p-3">
                                            <div class="d-flex">
                                                <div class="d-inline-flex flex-column">
                                                    <a href="javascript:void(0)" class="fs-lg fw-500 d-block">
                                                        Surgery & Labworks <span class="badge badge-success">Has
                                                            Access</span>
                                                    </a>
                                                    <div class="d-block text-muted fs-sm">
                                                        Duis placerat in sapien et placerat
                                        ...
                                        <div class="p-3 p-md-3">
                                            <div class="d-flex align-items-center">
                                                <div
                                                    class="d-inline-block align-middle status status-success status-sm mr-2">
                                                    <span class="profile-image-md rounded-circle d-block"
                                                        style="background-image:url('{{ asset('') }}assets/img/demo/avatars/avatar-k.png'); background-size: cover;"></span>
                                                </div>
                                                <div class="flex-1 min-width-0">
                                                    <a href="javascript:void(0)" class="d-block text-truncate">
