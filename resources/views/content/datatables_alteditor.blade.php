                ...
                <div class="d-flex flex-fill">
                    <div class="flex-fill">
                        ...
                        <p class="m-0">
                            ...
                            github may not be compatible with SmartAdmin.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                <p>
                                    Datatable accepts the following callback functions as arguments:
                                    <code>onAddRow(datatable, rowdata, success, error)</code>, <code>onEditRow(datatable,
                                        rowdata, success, error)</code>, <code>onDeleteRow(datatable, rowdata, success,
                                        error)</code>
                                </p>
                                <p>
                                    In the most common case, these function should call <code>$.ajax </code>as expected by
                                    the webservice. The two functions success and error should be passed as arguments to
                                    <code>$.ajax</code>. Webservice must return the modified row in JSON format, because the
                                    success() function expects this. Otherwise you have to write your own success() callback
                                    (e.g. refreshing the whole table).
                                </p>
                            </div>
                            <!-- tabs -->
                            ...
                            <div class="tab-content pt-4">
                                ...
                                <div class="tab-pane fade" id="tab_default-2" role="tabpanel">
                                    <div class="alert alert-info">
                                        ...
                                        included the latest version of Alt-editor (catered for SmartAdmin) inside
                                        <code>src/custom/plugins/datatables-alteditor/datatables-alteditor-latest.js</code>
                                        found only in the HTML flavor. You may switch to this latest version of Alt editor
                                        to gain access to the <strong>Support Modifiers</strong> below.
                                    </div>
                                    <!-- row -->
                                    <div class="row">
                                        <div class="col-12">
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>Type of HTML input to be shown. The value <code>readonly</code>
                                                            is accepted for backward compatibility, but deprecated.</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><code>true | false</code></td>
                                                        <td>Ensure that no two rows have the same value. The check is
                                                            performed client side, not server side. Set HTML
                                                            <code>"data-unique"</code> attribute. (Probably there's some
                                                            issue with this).
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td><code>"some msg"</code></td>
                                                        <td>An error message that is displayed when the unique constraint is
                                                            not respected. Set HTML <code>"data-uniqueMsg"</code> attribute.
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>special</code></td>
                                                        <td><code>"any string"</code></td>
                                                        <td>Set HTML <code>"data-special"</code> attribute (don't know
                                                            what's that needed for).</td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>editorOnChange</code></td>
                                                        <td>function</td>
                                                        <td>Custom onchange function. It will take as arguments the jquery
                                                            event and the altEditor object.</td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="3" class="py-4"><strong>Options for columns with
                                                                type <code>"text"</code>:</strong></td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>pattern</code></td>
                                                        <td><code>r.e.</code></td>
                                                        <td>The typed text will be matched against given regular expression,
                                                            before submit.</td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>msg</code></td>
                                                        <td><code>"some msg"</code></td>
                                                        <td>An error message that is displayed in case pattern is not
                                                            matched. Set HTML <code>"data-errorMsg"</code> attribute.</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><code>{}</code></td>
                                                        <td>Enable a datepicker component. jQuery-UI plugin must be linked.
                                                            More datepicker configuration options may be passed within the
                                                            object.</td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>datetimepicker</code></td>
                                                        <td><code>{}</code></td>
                                                        <td>Enable a datetimepicker component. jQuery datetimepicker plugin
                                                            must be linked. More datetimepicker configuration options may be
                                                            passed within the object.</td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="3" class="py-4"><strong>Options for columns with
                                                                type <code>"select"</code>:</strong></td>
                                                    </tr>
                                                    <tr>
                                                        <td><code>options</code></td>
                                                        <td><code>["a", "b", "c"]</code> or <code>{"a":"A", "b":"B",
                                                                "c":"C"}</code></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><code>{}</code></td>
                                                        <td>Enable a select2 component. Select2 jQuery plugin must be
                                                            linked. More select2 configuration options may be passed within
                                                            the object.</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td colspan="3" class="py-4"><strong>Options for columns with
                                                                type <code>"textarea"</code>:</strong></td>
                                                    </tr>
                                                    <tr>
            ...
            */
            ...
            var myTable = $('#dt-basic-example').dataTable({
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            return '<div class="has-popover d-flex align-items-center"><span class="d-inline-block rounded-circle mr-2 ' +
                                package[data].class +
                                '" style="width:15px; height:15px;"></span><span>' + package[data]
                                .title + '</span></div>';
                        },
                    },
                ],
                ...
                onAddRow: function(dt, rowdata, success, error) {
                    ...
                    // demo only below:
                    events.prepend('<p class="text-success fw-500">' + JSON.stringify(rowdata, null,
                        4) + '</p>');
                },
                onEditRow: function(dt, rowdata, success, error) {
                    ...
                    // demo only below:
                    events.prepend('<p class="text-info fw-500">' + JSON.stringify(rowdata, null, 4) +
                        '</p>');
                },
                onDeleteRow: function(dt, rowdata, success, error) {
                    ...
                    // demo only below:
                    events.prepend('<p class="text-danger fw-500">' + JSON.stringify(rowdata, null, 4) +
                        '</p>');
                },
            });
