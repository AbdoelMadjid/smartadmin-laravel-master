            ...
            <div class="d-flex flex-start w-100">
                ...
                <div class="d-flex flex-fill">
                    <div class="flex-fill">
                        ...
                        <p>A nifty plugin that lets you select colors on the fly. The color pallet is auto generated or can
                            be configured manually. The selection tool is loaded inside bootstrap's popover component,
                            allowing you to load it from any direction, even on bootstrap modals</p>
                        <p class="m-0">
                            Find in-depth, guidelines, tutorials and more on Bootstrap Colorpicker's <a
                                href="https://farbelous.io/bootstrap-colorpicker/" target="_blank">Official
                                Documentation</a>
                        </p>
                    </div>
                </div>
            ...
            <div class="col-xl-6">
                ...
                <div id="panel-2" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                <p>
                                    The initial color can be specified in 3 ways: input value, <var>data-color</var>
                                    attribute
                ...
                <div id="panel-3" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Whenever the <code>format</code> option is <var>'auto'</var>, the first parsed color format
                                will be detected and used as default, but when the option equals <var>null</var> (default),
                                the format is recalculated every time. You can see the differences here, one of them
                                allowing you to adjust the alpha channel:
                            </div>
                            <div class="demo-v-spacing">
                        ...
                        <div class="panel-content">
                            ...
                            <div id="cp5d" title="Using format option" class="mb-g">
                                <div class="input-group">
                                    <input type="text" class="form-control input-lg" value="rgb(203, 38, 192)"
                                        disabled />
                                </div>
                            </div>
                ...
                <div id="panel-7" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                When the alpha channel is disabled with the <code>useAlpha</code> option, the alpha bar will
                                be hidden and the color object will be restricted to opaque (alpha = 1).
                            </div>
                ...
                <div id="panel-7a" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                The colorpicker ColorItem class uses and comes bundled with Qix Color, a great color parsing
                                library with a friendly API that allows you to manipulate and convert the color. ColorItem
                                is just an abstraction layer on top of the library, which is more convenient for Bootstrap
                                Colorpicker. In this example we use the ColorItem API to add color swatches based on a
                                tetrad of the selected color
                            </div>
            ...
            <div class="col-xl-6">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                ...
                                element (otherwise it is placed in the body). This example also shows the two ways of using
                ...
                <div id="panel-9" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                This example shows how to avoid the input to have the hexadecimal hash prefix, using the
                                useHashPrefix option
                            </div>
                ...
                <div id="panel-11" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Use a predefined fallback color with the <code>fallbackColor</code> option, whenever the
                ...
                <div id="panel-14" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                You can use any Bootstrap Popover options (except: trigger, content and html) using the
                                "popover" property in the colorpicker options
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <input id="cp15" type="text" class="form-control input-lg"
                                                value="rgb(130, 44, 29)" />
                                        </div>
