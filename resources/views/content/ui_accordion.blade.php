            ...
            <div class="d-flex flex-start w-100">
                ...
                <div class="d-flex flex-fill">
                    <div class="flex-fill">
                        ...
                        <br>
                        Be sure to add <code>aria-expanded</code> to the control element. This attribute explicitly conveys
                        the current state of the collapsible element tied to the control to screen readers and similar
                        assistive technologies. If the collapsible element is closed by default, the attribute on the
                        control element should have a value of <code>aria-expanded="false"</code>. If you’ve set the
                        collapsible element to be open by default using the <code>show</code> class, set
                        <code>aria-expanded="true"</code> on the control instead.
                        <br>
                        <br>
                        Learn more about this plugin on bootstrap's <a
                            href="https://getbootstrap.com/docs/4.5/components/collapse/#accordion-example"
            ...
            <div class="col-xl-6">
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Just add <code>data-toggle="collapse"</code> and a <code>data-target</code> to the element
                                to automatically assign control of one or more collapsible elements. The
                                <code>data-target</code> attribute accepts a CSS selector to apply the collapse to. Be sure
                                to add the class <code>collapse</code> to the collapsible element. If you’d like it to
                                default open, add the additional class <code>show</code>.
                                <br>
                                <br>
                                To add accordion-like group management to a collapsible area, add the data attribute
                                <code>data-parent="#selector"</code>. Refer to the demo to see this in action.
                            </div>
                            <div class="accordion" id="js_demo_accordion-2">
                                <div class="card">
                                    <div class="card-header">
                                        <a href="javascript:void(0);" class="card-title" data-toggle="collapse"
                                            data-target="#js_demo_accordion-2a" aria-expanded="true">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <a href="javascript:void(0);" class="card-title collapsed" data-toggle="collapse"
                                            data-target="#js_demo_accordion-2b" aria-expanded="false">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <a href="javascript:void(0);" class="card-title collapsed" data-toggle="collapse"
                                            data-target="#js_demo_accordion-2c" aria-expanded="false">
                ...
                <div id="panel-2" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Change the style of your accordion by adding class <code>.accordion-outline</code> to
                                <code>.accordion</code>
                            </div>
                            <div class="accordion accordion-outline" id="js_demo_accordion-3">
                                <div class="card">
                                    ...
                                    <div id="js_demo_accordion-3a" class="collapse show"
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <a href="javascript:void(0);" class="card-title collapsed" data-toggle="collapse"
                                            data-target="#js_demo_accordion-3b" aria-expanded="false">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <a href="javascript:void(0);" class="card-title collapsed" data-toggle="collapse"
                                            data-target="#js_demo_accordion-3c" aria-expanded="false">
                ...
                <div id="panel-3" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Give your accordion a clean look by adding class <code>.accordion-clean</code> to
                                <code>.accordion</code>
                            </div>
                            <div class="accordion accordion-clean" id="js_demo_accordion-1">
                                <div class="card">
                                    ...
                                    <div id="js_demo_accordion-1a" class="collapse show"
                                        data-parent="#js_demo_accordion-1">
                                        <div class="card-body">
                                            Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry
                                            richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor
                                            brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor,
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <a href="javascript:void(0);" class="card-title collapsed" data-toggle="collapse"
                                            data-target="#js_demo_accordion-1b" aria-expanded="false">
                                            <span class="mr-2">
                                                <span class="collapsed-reveal">
                                                    <i class="fal fa-minus fs-xl"></i>
                                                </span>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <a href="javascript:void(0);" class="card-title collapsed" data-toggle="collapse"
                                            data-target="#js_demo_accordion-1c" aria-expanded="false">
                                            <span class="mr-2">
                                                <span class="collapsed-reveal">
                                                    <i class="fal fa-minus fs-xl"></i>
                                                </span>
            ...
            <div class="col-xl-6">
                <div id="panel-4" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Add some navigation to a card’s header (or block) with built-in nav components. You can
                                reveal or hide elements during <code>.collapse</code> state using the classes
                                <code>.collapsed-reveal</code> and <code>.collapsed-hidden</code>
                                <br><br>
                                <strong>Make sure the <code>.collapsed-*</code> classes are inside the
                                    <code>data-toggle="collapse"</code> element or adjacent to it</strong>
                            </div>
                            <div class="frame-wrap w-100">
                                <div class="accordion" id="js_demo_accordion-4">
                                    <div class="card">
                                        <div class="card-header">
                                            <a href="javascript:void(0);" class="card-title" data-toggle="collapse"
                                                data-target="#js_demo_accordion-4a" aria-expanded="true">
                                                Email marketing
                                                <span class="ml-auto">
                                                    <span class="collapsed-reveal">
                                        ...
                                        <div id="js_demo_accordion-4a" class="collapse show"
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <a href="javascript:void(0);" class="card-title collapsed"
                                                data-toggle="collapse" data-target="#js_demo_accordion-4b"
                                                aria-expanded="false">
                                                Online compaign
                                                <span class="ml-auto">
                                                    <span class="collapsed-reveal">
                                        ...
                                        <div id="js_demo_accordion-4b" class="collapse"
                                            data-parent="#js_demo_accordion-4">
                                            <div class="card-body">
                                                Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry
                                                richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <a href="javascript:void(0);" class="card-title collapsed"
                                                data-toggle="collapse" data-target="#js_demo_accordion-4c"
                                                aria-expanded="false">
                                        ...
                                        <div id="js_demo_accordion-4c" class="collapse"
                                            data-parent="#js_demo_accordion-4">
                                            <div class="card-body">
                                                Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry
                                                richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard
                ...
                <div id="panel-5" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Adding a hover effect adds nice element to your accordion. Achieve this by adding class
                                <code>.accordion-hover</code> to <code>.accordion</code>
                            </div>
                ...
                <div id="panel-6" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                <strong>Caution!</strong> Nested accordions will inherit the properties of its parent. In
                                the example below we use the default accordion for parent and a different style for
                                children.
                            </div>
                            <div class="accordion" id="js_demo_accordion-6">
                                <div class="card">
                                        ...
                                        <div class="card-title" data-toggle="collapse"
                                            ...
                                            <div class="d-flex flex-row align-items-center">
                                                ...
                                                <div class="info-card-text">
                                                    ...
                                                    <span
                                                        class="text-truncate text-truncate-md">drlantern@gotbootstrap.com</span>
                                                </div>
                                            </div>
                                    ...
                                    <div id="js_demo_accordion-6a" class="collapse show"
                                        data-parent="#js_demo_accordion-6">
                                        <div class="card-body">
                                            <!-- nested -->
                                            <div class="accordion" id="js_demo_accordion-7">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <a href="javascript:void(0);"
                                                            class="card-title px-3 py-2 bg-success-600 text-white"
                                                            data-toggle="collapse" data-target="#js_demo_accordion-7a"
                                                            aria-expanded="true">
                                                            Bloodworks
                                                            <span class="ml-auto">
                                                                <span class="collapsed-reveal">
                                                    ...
                                                    <div id="js_demo_accordion-7a" class="collapse show"
                                                        data-parent="#js_demo_accordion-7">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <a href="javascript:void(0);"
                                                            class="card-title px-3 py-2 collapsed bg-warning-500 text-dark"
                                                            data-toggle="collapse" data-target="#js_demo_accordion-7b"
                                                            aria-expanded="false">
                                                            Xray reports
                                                            <span class="ml-auto">
                                                                <span class="collapsed-reveal">
                                                    ...
                                                    <div id="js_demo_accordion-7b" class="collapse"
                                                        data-parent="#js_demo_accordion-7">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <a href="javascript:void(0);"
                                                            class="card-title px-3 py-2 collapsed bg-info-700 text-white"
                                                            data-toggle="collapse" data-target="#js_demo_accordion-7c"
                                                            aria-expanded="false">
                                                            ECG
                                                            <span class="ml-auto">
                                                                <span class="collapsed-reveal">
                                                    ...
                                                    <div id="js_demo_accordion-7c" class="collapse"
                                                        data-parent="#js_demo_accordion-7">
                                        ...
                                        <div class="card-title collapsed" data-toggle="collapse"
                                            ...
                                            <div class="d-flex flex-row align-items-center">
                                                ...
                                                <div class="info-card-text">
                                                    ...
                                                    <span
                                                        class="text-truncate text-truncate-md">jmilano@gotbootstrap.com</span>
                                                </div>
                                            </div>
                                            <span class="ml-auto align-self-start">
                                                <span class="collapsed-reveal">
