            ...
            <div class="d-flex flex-start w-100">
                ...
                <div class="d-flex flex-fill">
                    <div class="flex-fill">
                        ...
                        <p>Toastr is a Javascript library for Gnome / Growl type non-blocking notifications. jQuery is
                            required. The goal is to create a simple core library that can be customized and extended.</p>
                        <p class="m-0">
                            Find in-depth, guidelines, tutorials and more on Toastr's <a
                                href="https://github.com/CodeSeven/toastr" target="_blank">Official Documentation</a>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Below you will find various toast settings you can play around with. The Settings log will
                                produce the outcome code for the execution
                            </div>
                            <div class="row">
                                <div class="col-xl-4">
                                    ...
                                    <div class="custom-control custom-checkbox mb-2">
                                        ...
                                        <label class="custom-control-label" for="addBehaviorOnToastClick">Add behavior on
                                            toast click</label>
                                    </div>
                                    <div class="custom-control custom-checkbox mb-2">
                                    ...
                                    <div class="custom-control custom-checkbox mb-2">
                                        ...
                                        <label class="custom-control-label" for="preventDuplicates">Prevent
                                            Duplicates</label>
                                    </div>
                                    <div class="custom-control custom-checkbox mb-2">
                                        <input type="checkbox" class="custom-control-input" id="addClear">
                                        <label class="custom-control-label" for="addClear">Add button to force clearing a
                                            toast, ignoring focus</label>
                                    </div>
                                    <div class="custom-control custom-checkbox mb-2">
                                ...
                                <div class="col-xl-2">
                                    <fieldset class="form-group" id="toastTypeGroup">
                                        ...
                                        <div class="custom-control custom-radio mb-2">
                                            <input class="custom-control-input " name="toasts" id="typesuccess"
                                                type="radio" value="success" checked>
                                            <label class="custom-control-label" for="typesuccess"> Success </label>
                                        </div>
                                        <div class="custom-control custom-radio mb-2">
                                            <input class="custom-control-input " name="toasts" id="typeinfo"
                                                type="radio" value="info">
                                            <label class="custom-control-label" for="typeinfo"> Info </label>
                                        </div>
                                        <div class="custom-control custom-radio mb-2">
                                            <input class="custom-control-input" name="toasts" id="typewarning"
                                                type="radio" value="warning">
                                            <label class="custom-control-label" for="typewarning"> Warning </label>
                                        </div>
                                        <div class="custom-control custom-radio mb-2">
                                            <input class="custom-control-input" name="toasts" id="typeerror"
                                    ...
                                    <fieldset class="form-group" id="positionGroup">
                                        ...
                                        <div class="custom-control custom-radio mb-2">
                                            <input class="custom-control-input" name="position" id="topright"
                                                type="radio" value="toast-top-right" checked>
                                            <label class="custom-control-label" for="topright"> Top Right </label>
                                        </div>
                                        <div class="custom-control custom-radio mb-2">
                                            <input class="custom-control-input" name="position" id="bottomright"
                                                type="radio" value="toast-bottom-right">
                                            <label class="custom-control-label" for="bottomright"> Bottom Right </label>
                                        </div>
                                        <div class="custom-control custom-radio mb-2">
                                            <input class="custom-control-input" name="position" id="bottomleft"
                                                type="radio" value="toast-bottom-left">
                                            <label class="custom-control-label" for="bottomleft"> Bottom Left </label>
                                        </div>
                                        <div class="custom-control custom-radio mb-2">
                                            <input class="custom-control-input" name="position" id="topleft"
                                                type="radio" value="toast-top-left">
                                            <label class="custom-control-label" for="topleft"> Top Left </label>
                                        </div>
                                        <div class="custom-control custom-radio mb-2">
                                            <input class="custom-control-input" name="position" id="topfullwidth"
                                                type="radio" value="toast-top-full-width">
                                            <label class="custom-control-label" for="topfullwidth"> Top Full Width
                                            </label>
                                        </div>
                                        <div class="custom-control custom-radio mb-2">
                                            <input class="custom-control-input" name="position" id="bottomfullwidth"
                                                type="radio" value="toast-bottom-full-width">
                                            <label class="custom-control-label" for="bottomfullwidth"> Bottom Full Width
                                            </label>
                                        </div>
                                        <div class="custom-control custom-radio mb-2">
                                            <input class="custom-control-input" name="position" id="topcenter"
                                                type="radio" value="toast-top-center">
                                            <label class="custom-control-label" for="topcenter"> Top Center </label>
                                        </div>
                                        <div class="custom-control custom-radio mb-2">
                                            <input class="custom-control-input" name="position" id="bottomcenter"
                                                type="radio" value="toast-bottom-center">
                                ...
                                <div class="col-xl-2">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group flex-nowrap">
                                            <input type="number" class="form-control" id="showDuration"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group flex-nowrap">
                                            <input type="number" class="form-control" id="hideDuration"
                                                placeholder="ms" value="100">
                                            <div class="input-group-append">
                                                <span class="input-group-text">
                                                    ms
                                                </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group flex-nowrap">
                                            <input type="number" class="form-control" id="timeOut" placeholder="ms"
                                                value="5000">
                                            <div class="input-group-append">
                                                <span class="input-group-text">
                                                    ms
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group flex-nowrap">
                                            <input type="number" class="form-control" id="extendedTimeOut"
                        ...
                        <div
                            class="panel-content py-3 rounded-bottom border-faded border-left-0 border-right-0 border-bottom-0">
                            <button class="btn btn-primary mr-1" type="button" id="showtoast"> Open Toast </button>
                            <button class="btn btn-outline-primary mr-1" type="button" id="clearlasttoast"> Clear Last
                                Toast </button>
                            <button class="btn btn-outline-primary mr-1" type="button" id="cleartoasts"> Clear All
                                Toasts </button>
                        </div>
                    </div>
                </div>
