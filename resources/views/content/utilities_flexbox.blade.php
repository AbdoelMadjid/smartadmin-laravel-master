        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="alert alert-warning">
                    ...
                    <br>
                    The flexbox behaviours are an adaptation from the core bootstrap 4 CSS system. To learn further about
                    its responsive behaviours please head over to the <a
                        href="https://getbootstrap.com/docs/4.5/utilities/flex/" target="_blank">official documentation for
                        flexbox</a>.
                </div>
                <div class="card mb-g">
                    <div class="card-body">
                ...
                <div class="card mb-g">
                    <div class="card-body">
                        ...
                        <h5 class="frame-heading">
                            Use <code>.flex-column</code> to set a vertical direction, or <code>.flex-column-reverse</code>
                ...
                <div class="card mb-g">
                    <div class="card-body">
                        <h4 class="mb-g">
                            ...
                            <small>
                                <code>justify-content</code> utilities on flexbox containers to change the alignment of flex
                                items on the main axis (the x-axis to start, y-axis if <code>flex-direction: column</code>).
                                Choose from <code>start</code> (browser default), <code>end</code>, <code>center</code>,
                ...
                <div class="card mb-g">
                    <div class="card-body">
                        <h4 class="mb-g">
                            ...
                            <small>
                                Use <code>align-items</code> utilities on flexbox containers to change the alignment of flex
                                items on the cross axis (the y-axis to start, x-axis if <code>flex-direction:
                                    column</code>).
                            </small>
                        </h4>
                        <h5 class="frame-heading">
                            Choose from <code>start</code>, <code>end</code>, <code>center</code>, <code>baseline</code>, or
                    ...
                    <div class="card-body">
                        <h4 class="mb-g">
                            ...
                            <small>
                                ...
                                alignment on the cross axis (the y-axis to start, x-axis if <code>flex-direction:
                                    column</code>).
                            </small>
                        </h4>
                        <h5 class="frame-heading">
                            Choose from the same options as <code>align-items: start</code>, <code>end</code>,
                ...
                <div class="card mb-g">
                    <div class="card-body">
                        <h4 class="mb-g">
                            Fill
                            <small>
                                Use the <code>.flex-fill</code> class on a series of sibling elements to force them into
                ...
                <div class="card mb-g">
                    <div class="card-body">
                        <h4 class="mb-g">
                            ...
                            <small>
                                Use <code>.flex-grow-*</code> utilities to toggle a flex item’s ability to grow to fill
                        ...
                        <h5 class="frame-heading">
                            ...
                            necessary. In the example below, the second flex item with .<code>flex-shrink-1</code> is forced
                            to wrap it’s contents to a new line, “shrinking” to allow more space for the previous flex item
                    ...
                    <div class="card-body">
                        <h4 class="mb-g">
                            ...
                            <small>
                                ...
                                margin), pushing two items to the right (<code>.mr-auto</code>), and pushing two items to
                                the left (<code>.ml-auto</code>).
                            </small>
                        </h4>
                        <p>
                            <strong>Unfortunately, IE10 and IE11 do not properly support auto margins on flex items whose
                                parent has a non-default justify-content value.</strong> <a
                                href="https://stackoverflow.com/a/37535548" target="_blank">See this StackOverflow
                                answer</a>.
                        </p>
                        <div class="frame-wrap">
                    ...
                    <div class="card-body">
                        <h4 class="mb-g">
                            ...
                            <small>
                                ...
                                flex-direction: column, and <code>margin-top: auto</code> or <code>margin-bottom:
                                    auto</code>.
                            </small>
                        </h4>
                        <h5 class="frame-heading">
                    ...
                    <div class="card-body">
                        <h4 class="mb-g">
                            ...
                            <small>
                                ...
                                default) with <code>.flex-nowrap</code>, wrapping with <code>.flex-wrap</code>, or reverse
                ...
                <div class="card mb-g">
                    <div class="card-body">
                        <h4 class="mb-g">
                            Order
                            <small>
                                Change the <em>visual</em> order of specific flex items with a handful of <code>order</code>
                                utilities. We only provide options for making an item first or last, as well as a reset to
                                use the DOM order. As <code>order</code> takes any integer value (e.g., <code>5</code>), add
                    ...
                    <div class="card-body">
                        <h4 class="mb-g">
                            ...
                            <small>
                                ...
                                <code>stretch</code>. To demonstrate these utilities, we’ve enforced <code>flex-wrap:
                                    wrap</code> and increased the number of flex items.
                            </small>
                        </h4>
