...
@section('pages-css')
    ...
    <link rel="stylesheet" media="screen, print" href="{{ asset('') }}assets/css/formplugins/cropperjs/cropper.css">
            ...
            <div class="d-flex flex-start w-100">
                ...
                <div class="d-flex flex-fill">
                    <div class="flex-fill">
                        ...
                        <p>Cropperjs is a slick and lightweight responsive cropping tool for images. It supports <a
                                ...
                                target="_blank">27 methods</a> and 6 events. You can select an specific area of an image,
                            and then upload the coordinates data to server-side to crop the image, or crop the image on
                            browser-side directly. The plugin is regularly updated and has tons of potential! Making it a
                            great fit for SmartAdmin WebApp. </p>
                        <p class="m-0">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-xl-9">
                                        ...
                                        <div class="img-container">
                                            <img id="image" src="{{ asset('') }}assets/img/demo/gallery/3.jpg"
                                                alt="Picture">
                                        </div>
                                    </div>
                                    <div class="col-xl-3">
                                ...
                                <div class="row">
                                    <div class="col-lg-9 docs-buttons">
                                        ...
                                        <button type="button" class="btn btn-danger" data-method="destroy"
                                            title="Destroy">
                                            <span class="docs-tooltip" data-toggle="tooltip" data-animation="false"
                                        ...
                                        <!-- /.modal -->
                                        <button type="button" class="btn btn-secondary" data-method="getData"
                                        ...
                                        <button type="button" class="btn btn-secondary" data-method="getContainerData"
                                            data-option data-target="#putData">
                                            <span class="docs-tooltip" data-toggle="tooltip" data-animation="false"
                                        ...
                                        <button type="button" class="btn btn-secondary" data-method="getCanvasData"
                                            data-option data-target="#putData">
                                            <span class="docs-tooltip" data-toggle="tooltip" data-animation="false"
                                        ...
                                        <button type="button" class="btn btn-secondary" data-method="getCropBoxData"
                                            data-option data-target="#putData">
                                            <span class="docs-tooltip" data-toggle="tooltip" data-animation="false"
                                        ...
                                        <button type="button" class="btn btn-secondary" data-method="moveTo"
                                            data-option="0">
                                            <span class="docs-tooltip" data-toggle="tooltip" data-animation="false"
                                        ...
                                        <button type="button" class="btn btn-secondary" data-method="zoomTo"
                                            data-option="1">
                                            <span class="docs-tooltip" data-toggle="tooltip" data-animation="false"
                                        ...
                                        <button type="button" class="btn btn-secondary" data-method="rotateTo"
                                            data-option="180">
                                            <span class="docs-tooltip" data-toggle="tooltip" data-animation="false"
                                        ...
                                        <button type="button" class="btn btn-secondary" data-method="scale"
                                    ...
                                    <div class="col-lg-3 docs-toggles">
                                        ...
                                        <div class="dropdown dropup docs-options">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="toggleOptions" role="menu">
                                                <li class="dropdown-item">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label"
                                                            for="responsive">responsive</label>
                                                    </div>
                                                </li>
                                                <li class="dropdown-item">
                                                    <div class="form-check">
                                                ...
                                                <li class="dropdown-item">
                                                    <div class="form-check">
                                                        <input class="form-check-input" id="checkCrossOrigin"
                                                ...
                                                <li class="dropdown-item">
                                                    <div class="form-check">
                                                        <input class="form-check-input" id="checkOrientation"
                                                ...
                                                <li class="dropdown-item">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label"
                                                            for="zoomOnTouch">zoomOnTouch</label>
                                                    </div>
                                                </li>
                                                <li class="dropdown-item">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label"
                                                            for="zoomOnWheel">zoomOnWheel</label>
                                                    </div>
                                                </li>
                                                <li class="dropdown-item">
                                                    <div class="form-check">
                                                        <input class="form-check-input" id="cropBoxMovable"
                                                ...
                                                <li class="dropdown-item">
                                                    <div class="form-check">
                                                        <input class="form-check-input" id="cropBoxResizable"
                                                ...
                                                <li class="dropdown-item">
                                                    <div class="form-check">
                                                        <input class="form-check-input" id="toggleDragModeOnDblclick"
...
@section('pages-script')
    <script src="{{ asset('') }}assets/js/formplugins/cropperjs/cropper.js"></script>
    <script>
        $(function() {
            'use strict';
