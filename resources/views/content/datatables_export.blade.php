    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            @component('layouts._page_heading', [
                ...
                'heading2' => 'Export',
                'sup' => 'ADDON',
                'pagedescription' => 'Export datatables to PDF, Excel, and CSV formats - without any hassle!',
            ])
            @endcomponent
        </div>
        <div class="row">
                ...
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                <p>Exporting data from a table can often be a key part of a complex application. The Buttons
                                    extension for DataTables provides three plug-ins that provide overlapping functionality
                                    for data export:</p>
                                <ul>
                                    <li>
                                ...
                                <p>
                                    Since SmartAdmin WebApp is built for the "next generation" browsers, we removed the
                                    flash (.swf) alternative plugin due to security reasons and ActionScript's memory
                                    leakage
                                </p>
                            </div>
                            <!-- datatable start -->
