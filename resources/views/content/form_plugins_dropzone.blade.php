...
@section('pages-css')
    <link rel="stylesheet" media="screen, print" href="{{ asset('') }}assets/css/formplugins/dropzone/dropzone.css">
@endsection
...
@section('pages-script')
    <script src="{{ asset('') }}assets/js/formplugins/dropzone/dropzone.js"></script>
@endsection
