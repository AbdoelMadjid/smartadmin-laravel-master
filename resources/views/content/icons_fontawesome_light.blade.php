    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            @component('layouts._page_heading', [
                ...
                'heading2' => 'Light',
                'pagedescription' => 'Font Awesome 5 Pro Light',
            ])
            @endcomponent
        </div>
...
@section('pages-script')
    <script>
        ...
        var filename =
            "{{ asset('') }}assets/media/data/fa-icon-list"; //available JSON files [ng-icon-base, ng-icon-list, ng-text-colors, fa-brand-list, fa-icon-list]
