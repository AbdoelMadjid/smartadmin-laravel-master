            ...
            <div class="d-flex flex-start w-100">
                ...
                <div class="d-flex flex-fill">
                    <div class="flex-fill">
                        ...
                        <p>Enhancing native selects with search by using native selects with a better multi-select
                            interface. Easily load items via AJAX and have them searchable. Native selects only support one
                            level of nesting. Select2 does not have this restriction. You can also work with large, remote
                            datasets: ability to partially load a dataset based on the search term.</p>
                        <p>
                            Find in-depth, guidelines, tutorials and more on Select2's <a
                                href="https://github.com/select2/select2" target="_blank">Official Documentation</a>
                        </p>
                        <p class="fs-xs text-muted m-0">
                            <strong>IE10 Support:</strong> Since this is the latest version of select2 with a customized UI
                            to match SmartAdmin WebApp, some parts of select2 may have issues with IE10. This is due to the
                            limitation of IE10 CSS & Javascript engine, which is currently outdated and has no workaround
                            method. You may use earlier version of select2 and its vanilla skin if select2 is a must have
                            for your list of plugins.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="help-block">A placeholder value can be defined and will be displayed until a
                                    selection is made. Select2 uses the placeholder attribute on multiple select boxes.
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="help-block">Select2 will respond to the <code>disabled</code> attribute on
                            ...
                            <div class="form-group">
                                ...
                                <div class="help-block">Select2 allows you to hide the search box depending on the number
                                    of options which are displayed. In this example, we use the value <code>Infinity</code>
                                    to tell Select2 to never display the search box.</div>
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="select2-ajax">
                                    Select remote Ajax search
                                </label>
                                <select data-placeholder="Select a state..." class="js-data-example-ajax form-control"
                                    id="select2-ajax"></select>
                                <div class="help-block">You can configure how Select2 searches for remote data using the
                                    ajax option. Select2 will pass any options in the ajax object to jQuery's
                                    <code>$.ajax</code> function, or the transport function you specify.
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="help-block">Use <code>.select2</code> class for basic select2 control. Use
                                    <code>multiple="multiple"</code> attribute for multiple select box</div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="help-block">Select2 multi-value select boxes can set restrictions regarding the
                                    maximum number of options selected. The select below is declared with the
                                    <code>multiple</code> attribute with <code>maximumSelectionLength</code> in the select2
                                    options.
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <select data-placeholder="Select a state..." class="js-select2-icons form-control"
                                    id="multiple-icons" multiple="multiple">
                                    <optgroup label="Services">
                                        <option value="wordpress" data-icon="fab fa-wordpress text-dark" selected="">
                                            WordPress</option>
                                        ...
                                        <option value="pinterest" data-icon="fab fa-pinterest color-primary-300">CSS3
                                        </option>
                                    ...
                                    <optgroup label="File types">
                                        ...
                                        <option value="excel" data-icon="fal fa-file-excel color-success-700">Excel
                                        </option>
                                        <option value="powerpoint" data-icon="fal fa-file color-danger-900">PowerPoint
                                        </option>
                                    </optgroup>
                                ...
                                <div class="help-block">Use data attribute <code>data-icon</code> to add icon name for each
                                    options. And use class <code>.js-select2-icons</code> to set icon with option.</div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            $(function() {
                ...
                function icon(elm) {
                    elm.element;
                    return elm.id ? "<i class='" + $(elm.element).data("icon") + " mr-2'></i>" + elm.text :
                        elm.text
                }
