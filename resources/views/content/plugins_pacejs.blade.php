    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-shield-alt'></i> PaceJS <sup
                    class='badge badge-warning fw-500'>RECOMMENDED</sup>
                <small>
                    Include pace.js and a CSS theme of your choice, and you get a beautiful progress indicator for your page
                    load and ajax navigation.
                </small>
            </h1>
        </div>
            ...
            <div class="d-flex flex-start w-100">
                ...
                <div class="d-flex flex-fill">
                    <div class="flex-fill">
                        ...
                        <p>This plugin is not required but <strong>highly recommended</strong>. If you decide to remove
                            PaceJS from core, Internet Explorer may have some CSS issues during page load. Some animations
                            will execute before a page is fully loaded, resulting 'jumpy / jerky' animations.</p>
                        <p class="m-0">
                            Find in-depth, guidelines, tutorials and more on Pace's <a
                                href="https://github.hubspot.com/pace/" target="_blank">Official Documentation</a>
                        </p>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="flex-1">
                                            <div class="d-flex app-body-demo border-top-0 border-left-0">
                                                ...
                                                <div class="d-flex flex-column flex-1">
                                                    <div class="app-header-demo bg-success-50 pattern-1"></div>
                                                    <div
                                                        class="app-container-demo bg-faded d-flex align-items-center justify-content-center flex-1">
                                                        <div class="text-center" style="width:100px">
                                                            <div class="progress progress-sm bg-white rounded-0"
            ...
            <div class="col-xl-12">
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                SmartAdmin WebApp comes with integrated and customized styles for PaceJS plugin. PaceJS in
                                short, improves usability from an user's point of view
                            </div>
                            <div class="row">
                                <div class="col-xl-12">
                                        ...
                                        <table class="table table-bordered mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="fs-sm">
                                                        Show the progress bar and start updating. Called automatically if
                                                        you don't use AMD or CommonJS.
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td class="fs-sm">
                                                        Show the progress bar if it's hidden and start reporting the
                                    ...
                                    <h5 class="frame-heading">Configuration
                                        <small>
                                            Pace is fully automatic, no configuration is necessary to get started. If you
                                            would like to make some tweaks, here's how. You can set
                                            <code>window.paceOptions</code> before bringing in the file:</small>
                                    </h5>
                                    <div class="frame-wrap">
