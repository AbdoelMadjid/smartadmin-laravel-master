                ...
                <div class="d-flex flex-fill">
                    <div class="flex-fill">
                        ...
                        <p>
                            ...
                            looks and interactive features. Additional examples are bundled with Flot. Flot is easy to use,
                            just a few lines of code, you can make a simple line chart, it also provides a comprehensive API
                            documentation where you can find examples, usage and methods. The most important part, Flot
                            continues to release new versions, each new version comes with new features.
                        </p>
                        <p class="m-0">
                            Find more examples and guidelines on Flot's <a href="https://www.flotcharts.org/flot/examples/"
                                target="_blank">official documentation</a> and detailed tutorials on <a
                                href="http://www.jqueryflottutorial.com/how-to-make-jquery-flot-line-chart.html"
                                target="_blank">Flot Tutorials</a>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                We use a combination of various plots to create a more intricate diagram. More basic
                                examples of plot can be found below
                            </div>
            ...
            <div class="col-xl-6">
                <div id="panel-2" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Single barchart to display timeline differences. It is currently displaying only one group
                                of data
                            </div>
                ...
                <div id="panel-4" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Adding tooltips is easy, you will need to include the plugin
                                <code>jquery.flot.tooltip.js</code>
                            </div>
                ...
                <div id="panel-6" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Generates random data to populate and redraw recursively, we use the
                                <code>jquery.flot.spline.js</code> plugin to make the lines curvey
                            </div>
                            <div class="btn-group">
                                <button class="btn btn-secondary btn-sm dropdown-toggle mb-g" type="button"
                                    data-toggle="dropdown" aria-expanded="false"> Change interval </button>
                                <div class="dropdown-menu dropdown-lg p-0">
                                    <div class="px-4 py-2 d-flex align-items-center justify-content-center">
                                        <input type="range" class="custom-range js-set-interval"
                                            id="js-flot-realtime-curved-speed" min="-1000" max="-100"
                                            step="100" value="-1000">
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-xl-6">
                <div id="panel-7" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Here we compare relations of different data groups, the greater the length of bar, bigger
                                the value
                            </div>
                ...
                <div id="panel-8" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Curved lines by using the plugin <code>jquery.flot.spline.js</code>, adding a nice
                                transition to the eyes
                            </div>
                ...
                <div id="panel-11" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                In this interval example we fill the whitespace. You can also try the interval button to
                                change the speed of the redrawing
                            </div>
                            <div class="btn-group">
                                <button class="btn btn-secondary btn-sm dropdown-toggle mb-g" type="button"
                                    data-toggle="dropdown" aria-expanded="false"> Change interval </button>
                                <div class="dropdown-menu dropdown-lg p-0">
                                    <div class="px-4 py-2 d-flex align-items-center justify-content-center">
                                        <input type="range" class="custom-range js-set-interval"
                                            id="js-flot-realtime-fill-speed" min="-1000" max="-100"
                                            step="100" value="-1000">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                ...
                                simple, in order to make pie chart you have to incldue <code>jquery.flot.pie.js</code>
                                plugin
                            </div>
                            <div class="row">
                                <div class="col-xl-5">
                                ...
                                <div class="col-xl-6 offset-xl-1">
                                    <div class="h-100 d-flex align-items-center mt-3 mt-xl-0">
                                        <div class="demo">
                                            <button id="example-1" class="btn btn-outline-primary js-pie-example">Default
                                                Options</button>
                                            <button id="example-2" class="btn btn-outline-primary js-pie-example">Without
                                                Legend</button>
                                            <button id="example-3" class="btn btn-outline-primary js-pie-example">Label
                                                Formatter</button>
                                            <button id="example-4" class="btn btn-outline-primary js-pie-example">Label
                                                Radius</button>
                                            <button id="example-5" class="btn btn-outline-primary js-pie-example">Label
                                                Styles #1</button>
                                            <button id="example-6" class="btn btn-outline-primary js-pie-example">Label
                                                Styles #2</button>
                                            <button id="example-7" class="btn btn-outline-primary js-pie-example">Hidden
                                                Labels</button>
                                            <button id="example-8" class="btn btn-outline-primary js-pie-example">Combined
                                                Slice</button>
                                            <button id="example-9"
                                                class="btn btn-outline-primary js-pie-example">Rectangular Pie</button>
                                            <button id="example-10" class="btn btn-outline-primary js-pie-example">Tilted
                                                Pie</button>
                                            <button id="example-11" class="btn btn-outline-primary js-pie-example">Donut
                                                Hole</button>
                                            <button id="example-12"
                                                class="btn btn-outline-primary js-pie-example">Interactivity</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
