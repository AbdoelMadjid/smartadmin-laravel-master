    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-credit-card-front'></i> Ion.RangeSlider<sup
            ...
            <div class="d-flex flex-start w-100">
                ...
                <div class="d-flex flex-fill">
                    <div class="flex-fill">
                        ...
                        <p>Easy to use, flexible and responsive range slider comes with skin support (6 skins included).
                            Features include two types of sliders (1 or double), support for negative and fractional values.
                            Ability to setup custom step and snap to grid option. Customizable grid values and the ability
                            to add port & prefixes. Slider writes its value right into input value field, making it easy to
                            use in any HTML form. You can have many sliders in one page without any conflict.</p>
                        <p class="m-0">
                            Find in-depth, guidelines, tutorials and more on Ion.RangeSlider's <a
                                href="http://ionden.com/a/plugins/ion.rangeSlider/index.html" target="_blank">Official
                                Documentation</a>
                        </p>
                    </div>
                </div>
                        ...
                        <div id="panel-1" class="panel">
                            ...
                            <div class="panel-container show">
                                <div class="panel-content">
                                    ...
                                    <input id="demo_1" type="text" value="" class="d-none" tabindex="-1"
                                        readonly="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="panel-2" class="panel">
                            ...
                            <div class="panel-container show">
                                <div class="panel-content">
                                    ...
                                    <input id="demo_2" type="text" value="" class="d-none" tabindex="-1"
                                        readonly="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="panel-3" class="panel">
                            ...
                            <div class="panel-container show">
                                <div class="panel-content">
                                    ...
                                    <input id="demo_3" type="text" value="" class="d-none" tabindex="-1"
                                        readonly="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="panel-4" class="panel">
                            ...
                            <div class="panel-container show">
                                <div class="panel-content">
                                    ...
                                    <input id="demo_4" type="text" value="" class="d-none" tabindex="-1"
                                        readonly="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="panel-5" class="panel">
                            ...
                            <div class="panel-container show">
                                <div class="panel-content">
                                    ...
                                    <input id="demo_5" type="text" value="" class="d-none" tabindex="-1"
                                        readonly="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="panel-6" class="panel">
                            ...
                            <div class="panel-container show">
                                <div class="panel-content">
                                    ...
                                    <input id="demo_6" type="text" value="" class="d-none" tabindex="-1"
                                        readonly="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="panel-7" class="panel">
                            ...
                            <div class="panel-container show">
                                <div class="panel-content">
                                    ...
                                    <input id="demo_7" type="text" value="" class="d-none" tabindex="-1"
                                        readonly="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="panel-8" class="panel">
                            ...
                            <div class="panel-container show">
                                <div class="panel-content">
                                    ...
                                    <input id="demo_8" type="text" value="" class="d-none" tabindex="-1"
                                        readonly="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="panel-9" class="panel">
                            ...
                            <div class="panel-container show">
                                <div class="panel-content">
                                    ...
                                    <input id="demo_9" type="text" value="" class="d-none" tabindex="-1"
                                        readonly="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="panel-10" class="panel">
                            ...
                            <div class="panel-container show">
                                <div class="panel-content">
                                    ...
                                    <input id="demo_10" type="text" value="" class="d-none" tabindex="-1"
                                        readonly="">
                                </div>
                            </div>
                        </div>
